...
public class girlPowerTest {
    public Quoter girlQuoter = new Quoter();
    ...
    public void testMain() throws MalformedURLException {
        URL wsdlUrl = new
                URL("http://localhost:9003/quotation?wsdl");
        QName serviceName =
                new QName("http://quote/", "QuoterService");
        Service service = Service.create(wsdlUrl, serviceName);
        QName portName = new QName("http://quote/", "QuoterPort");
    ...
    public void testGetQuotation() {
        Quotation quote = girlQuoter.generateQuotation(new ClientInfo("Donald Duck", ClientInfo.MALE, 35, 5, 2, "XYZ567/9"));

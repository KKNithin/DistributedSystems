...
public class DodgydriversQuoterTest {
    public Quoter dodgyQuoter = new Quoter();
    ...
    public void testMain() throws MalformedURLException {
        URL wsdlUrl = new
                URL("http://localhost:9002/quotation?wsdl");
        QName serviceName =
                new QName("http://quote/", "QuoterService");
        Service service = Service.create(wsdlUrl, serviceName);
        QName portName = new QName("http://quote/", "QuoterPort");
    ...
    public void testGetQuotation() {
        Quotation quote = dodgyQuoter.generateQuotation(new ClientInfo("Donald Duck", ClientInfo.MALE, 35, 5, 2, "XYZ567/9"));
